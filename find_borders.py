...
if __name__ == '__main__':
    ...
    top, bottom = findLine(image)
    cv2.line(line_detected, top, bottom, (208, 216, 75), 15)  # draw and show line between 2 points that we found
    ...
    output, circle = fineCircle(image)
    print(circle)
